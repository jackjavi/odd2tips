...
export const metadata: Metadata = {
  title:
    "Football Match Results | Expert Football Predictions & Betslips & Football News",
  description:
    "Football results from top leagues - English Premier League, La Liga, Serie A, Bundesliga, Ligue 1, and more. Get the latest trending news in the football world. Stay updated with the latest news, fixtures, football free daily predictions, and results.",
  keywords: [
