...
const BetSlipPromotion: React.FC = () => {
  return (
    <section className="bg-teal-600   md:h-[50vh] w-[90vw] md:w-[80vw] px-2 py-4 mx-auto text-white  shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out flex flex-col items-center justify-center">
