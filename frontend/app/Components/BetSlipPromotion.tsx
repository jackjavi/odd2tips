...
const BetSlipPromotion: React.FC = () => {
  return (
    <section className="bg-teal-600 container h-[50vh] mx-auto text-white p-6 shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out flex flex-col items-center justify-center">
